<template>
  ...
  <el-table :data="displayedItems"
    ...
    <el-table-column prop="feedbackType" label="反馈类型" width="400" ></el-table-column>
    <el-table-column prop="content" label="问题反馈" width="400" ></el-table-column>
...
// 发送请求获取数据
axios.get("http://localhost:8080/feedbackToPublisher/findAll").then((response) => {
...
//获取当前页数据
const getData = () => {
  axios.get(`http://localhost:8080/feedbackToPublisher/findByPage`, {
    params: {

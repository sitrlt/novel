...
const recommendBooks = ref([
  {genre: '古代言', title: '京师无人生还'},
  {genre: '现代言', title: '京港婚事'},
  {genre: '现代言', title: '顶级溺宠，京圈太子…'},
  {genre: '古代言', title: '大宋瓷娘子'},
  {genre: '古代言', title: '平城赋'},
  {genre: '古代言', title: '开着房车，去古代逃…'},
  {genre: '古代言', title: '妾室娇软妩媚，太子…'},
  {genre: '现代言', title: '甜婚蜜意'},
  {genre: '古代言', title: '进宝京华录'},
  {genre: '古代言', title: '掐指一算，五婚临门'},
  {genre: '现代言', title: '假千金一卦难求，全…'},
  {genre: '现代言', title: '重生年代，福气包在…'},
  {genre: '现代言', title: '婚色诱瘾'}
]);

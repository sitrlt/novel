...
const sendVerificationCode = async () => {
  ...
  try {
    ...
    const response = await axios.post('http://localhost:8080/publishers/forget', loginData);
    // 请求成功，收到验证码
...
const onSubmit = () => {
  ...
  axios.post('http://localhost:8080/publishers/update',loginData).then((response)=>{
